	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err != nil || err2 != nil {
			...
			if err != nil {
				...
				notification8.PoolHelper.PublishSysErrorNotification("Error in `NaabuM8 Launch` command line when initialising the API endpoint", "urgent", "naabum8")
				return err
			}
			a.Routes()
...
func init() {
	...
	launchCmd.Flags().Int("port", 8001, "Port bind to the service. By default, it will listen to port 8001.")
